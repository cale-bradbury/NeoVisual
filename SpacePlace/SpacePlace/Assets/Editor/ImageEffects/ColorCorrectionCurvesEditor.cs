...
namespace UnityStandardAssets.ImageEffects
{
    ...
    class ColorCorrectionCurvesEditor : Editor {
        ...
        SerializedProperty selectiveCamp;
        ...
        void OnEnable () {
            ...
            selectiveCamp = serObj.FindProperty ("selectiveCamp");
        ...
        public override void OnInspectorGUI () {
            ...
            EditorGUILayout.Separator ();
            EditorGUILayout.PropertyField (selectiveCamp, new GUIContent ("Selective"));
            if (selectiveCamp.boolValue) {
