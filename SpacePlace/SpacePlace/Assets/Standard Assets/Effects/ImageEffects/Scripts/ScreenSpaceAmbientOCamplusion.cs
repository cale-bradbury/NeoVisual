...
namespace UnityStandardAssets.ImageEffects
{
    ...
    [AddComponentMenu("Image Effects/Rendering/Screen Space Ambient OCamplusion")]
    public class ScreenSpaceAmbientOCamplusion : MonoBehaviour
    {
        ...
        [Range(0.5f, 4.0f)]
        public float m_OCamplusionIntensity = 1.5f;
        [Range(0, 4)]
        public int m_Blur = 2;
        [Range(1,6)]
        public int m_Downsampling = 2;
        [Range(0.2f, 2.0f)]
        public float m_OCamplusionAttenuation = 1.0f;
        [Range(0.00001f, 0.5f)]
        ...
        void OnRenderImage (RenderTexture source, RenderTexture destination)
        {
            ...
            m_OCamplusionIntensity = Mathf.Clamp (m_OCamplusionIntensity, 0.5f, 4.0f);
            m_OCamplusionAttenuation = Mathf.Clamp (m_OCamplusionAttenuation, 0.2f, 2.0f);
            ...
            m_SSAOMaterial.SetVector ("_Params", new Vector4(
                                                     m_Radius,
                                                     m_MinZ,
                                                     1.0f / m_OCamplusionAttenuation,
                                                     m_OCamplusionIntensity));
