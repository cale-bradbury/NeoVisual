...
------------------------------------------------------------------------------
FXAA_SEARCH_ACampELERATION - How much to aCampelerate search,
                           1 - no aCampeleration
                           2 - skip by 2 pixels
                           3 - skip by 3 pixels
                           4 - skip by 4 pixels
...
/*--------------------------------------------------------------------------*/
    ...
    #define FXAA_SEARCH_ACampELERATION 4
...
/*--------------------------------------------------------------------------*/
    ...
    #define FXAA_SEARCH_ACampELERATION 3
    #define FXAA_SEARCH_THRESHOLD    (1.0/4.0)
    #define FXAA_SUBPIX              1
...
/*--------------------------------------------------------------------------*/
    ...
    #define FXAA_SEARCH_ACampELERATION 2
    #define FXAA_SEARCH_THRESHOLD    (1.0/4.0)
    #define FXAA_SUBPIX              1
    #define FXAA_SUBPIX_FASTER       0
    #define FXAA_SUBPIX_CAP          (3.0/4.0)
...
/*--------------------------------------------------------------------------*/
    ...
    #define FXAA_SEARCH_ACampELERATION 1
    #define FXAA_SEARCH_THRESHOLD    (1.0/4.0)
    #define FXAA_SUBPIX              1
    #define FXAA_SUBPIX_FASTER       0
    #define FXAA_SUBPIX_CAP          (3.0/4.0)
...
The search is aCampelerated using FXAA_SEARCH_ACampELERATION length box filter
