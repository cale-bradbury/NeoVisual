// Upgrade NOTE: replaced 'mul(UNITY_MATRIX_MVP,*)' with 'UnityObjectToClipPos(*)'
 ...
 Shader "Hidden/Dof/DepthOfField34" {
	...
	v2fDown vertDownsampleWithCoCamponserve(appdata_img v) {
		v2fDown o;
		o.pos = UnityObjectToClipPos(v.vertex);	
	...
	half4 fragDownsampleWithCoCamponserve(v2fDown i) : SV_Target {
		half2 rowOfs[4];   
...
Subshader {
 ...
 Pass {
      ...
      CGPROGRAM
      #pragma vertex vertDownsampleWithCoCamponserve
      #pragma fragment fragDownsampleWithCoCamponserve
      ENDCG
  	} 
